...
fun main(){
    AircraftSecondVersion("Боинг 737-800", 50000f, 200).getInfo()
}

class AircraftSecondVersion(private val number: String, private val maxFlightDistance: Float, private val tankCapacity: Int) {
